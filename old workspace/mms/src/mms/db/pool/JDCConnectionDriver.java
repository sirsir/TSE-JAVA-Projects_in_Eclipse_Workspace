...
public class JDCConnectionDriver implements Driver {
    ...
    public JDCConnectionDriver(String driver, String url) throws ClassNotFoundException, InstantiationException, IllegalAccessException, SQLException	{
		DriverManager.registerDriver(this);
		Class.forName(driver).newInstance();
		pool = new JDCConnectionPool(url);		
	}
